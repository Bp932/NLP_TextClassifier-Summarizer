...
'''
def plot_distributions(dtf, x, max_cat=100, top=None, y=None, bins=None, figsize=(10,5)):
    ## univariate
    if y is None:
...
def bart_ui(corpus):
    ...
    summary= [summarizer(txt[:250],max_length=50,min_length=30,do_sample=False) for txt in corpus]
    return summary